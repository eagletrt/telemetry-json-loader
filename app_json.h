...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("fields_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("axis_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("custom_plots_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("color_o NOT AN OBJECT");
        return false;
    }
    bool check = true;
    if(!doc.HasMember("r")){
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("json_trigger_o NOT AN OBJECT");
        return false;
    }
    bool check = true;
    if(!doc.HasMember("message")){
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("events_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("post_proc_o NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("saved_confs_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("app_connection_o NOT AN OBJECT");
        return false;
    }
    bool check = true;
    if(!doc.HasMember("ip")){
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("paths_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("generic_key_value_a NOT AN OBJECT");
        return false;
    }
    bool check = true;
    if(!doc.HasMember("key")){
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("user_data_t NOT AN OBJECT");
        return false;
    }
    bool check = true;
...
{
    if(!doc.IsObject()){
        JSON_LOG_FUNC("app_config_t NOT AN OBJECT");
        return false;
    }
    bool check = true;
