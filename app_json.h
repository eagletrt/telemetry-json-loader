...
typedef struct generic_key_value_o{
    std::string key;
    std::string value;
}generic_key_value_o;
...
typedef struct app_config{
    std::vector<generic_key_value_o> generic_key_value;
...
template <>
bool CheckJson(const generic_key_value_o& obj, const rapidjson::Document& doc)
{
    bool check = true;
...
template<>
void Serialize(rapidjson::Value& out, const generic_key_value_o& obj, rapidjson::Document::AllocatorType& alloc)
{
    out.SetObject();
